...
reduc = numel(area_NH); 
area_NH = area_NH(5:8:end,5:8:end);
area_NH = reduc / numel(area_NH) * area_NH; 
%%
...
reduc = numel(area_SH); 
area_SH = area_SH(5:8:end,5:8:end);
area_SH = reduc / numel(area_SH) * area_SH; 
...
save('KDTree_200km.mat','KDTree','lat_X','lon_X','*_SH','*_NH'); 
%%
